...
m_wbb = st.number_input('m_wbb: Particle mass at the W+-W+-b final state', min_value=0.001, max_value=10.0, value=1.0,key="4",format="%.4f")

m_jjj = st.number_input('m_jjj: The invariant mass of the three jets ', min_value=0.001, max_value=10.0, value=1.0,key="5",format="%.4f")
